...
/*     $sqlShowAll= "SELECT Person.PersonID AS 'PersonID', Person.FirstName AS 'FN', Person.MiddleInitial AS 'MI',
    ...
    FROM Person
      ...
      JOIN VolunteerDepartment ON Volunteer.VolunteerID = VolunteerDepartment.VolunteerID
      JOIN Shift ON VolunteerDepartment.DepartmentID = Shift.DepartmentID
    WHERE Shift.CheckedIn = 'y' AND Shift.DepartmentID = 1
    ORDER BY Person.LastName;";
    ...
    FROM Person
      ...
      JOIN VolunteerDepartment ON Volunteer.VolunteerID = VolunteerDepartment.VolunteerID
      JOIN Shift ON VolunteerDepartment.DepartmentID = Shift.DepartmentID
    WHERE Shift.CheckedIn = 'y' AND Shift.DepartmentID = 2
    ORDER BY Person.LastName;";
    ...
    FROM Person
      ...
      JOIN VolunteerDepartment ON Volunteer.VolunteerID = VolunteerDepartment.VolunteerID
      JOIN Shift ON VolunteerDepartment.DepartmentID = Shift.DepartmentID
    WHERE Shift.CheckedIn = 'y' AND Shift.DepartmentID = 3
    ORDER BY Person.LastName;";
    ...
    FROM Person
      ...
      JOIN VolunteerDepartment ON Volunteer.VolunteerID = VolunteerDepartment.VolunteerID
      JOIN Shift ON VolunteerDepartment.DepartmentID = Shift.DepartmentID
    WHERE Shift.CheckedIn = 'y' AND Shift.DepartmentID = 4
    ORDER BY Person.LastName;";
...
<head>
	...
	<style type = "text/css" rel="stylesheet">
	 header{
		 background-image: url('img/snake2.jpg') !important;
	 }
...
<div id="wrapper">
    <form name = "WhosHere" method="post">
        ...
        <div id="page-wrapper" class="gray-bg">
            ...
            <div class="col-md-12">
                <div class = "row">
                    <header style="background-image:url('img/owl_here.jpg')!important;" class="image-bg-fluid-height who-header-background" >
					
                        <br/><br/><br/><br/><br/><br/><br/>
                        <h1 class="welcome-user"> WHO'S HERE </h1>
                    </header>
                </div>
            </div>
            <!--Start Table -->
