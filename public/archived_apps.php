<?php
    ...
    $sqlShowAll= "SELECT Person.PersonID AS 'PersonID', Person.FirstName AS 'FN', Person.MiddleInitial AS 'MI',
                       Person.LastName AS 'LN', Department.DepartmentName AS 'Dept', Application.LastUpdated AS 'AppLastUpdated', Application.ApplicationStatus AS 'ApplicationStatus'
                       FROM Person
                       ...
                       WHERE Application.ApplicationStatus = 'Accepted' or Application.ApplicationStatus = 'Rejected'
    ...
    FROM Person
      JOIN Application ON Person.PersonID = Application.PersonID
      JOIN Department ON Application.DepartmentID = Department.DepartmentID
      WHERE Department.DepartmentID = 2 AND Application.ApplicationStatus = 'Accepted' or Department.DepartmentID = 2 AND Application.ApplicationStatus = 'Rejected'
    ORDER BY Person.LastName;";
    ...
    FROM Person
      JOIN Application ON Person.PersonID = Application.PersonID
      JOIN Department ON Application.DepartmentID = Department.DepartmentID
      WHERE Department.DepartmentID = 1 AND Application.ApplicationStatus = 'Accepted' or Department.DepartmentID = 1 AND Application.ApplicationStatus = 'Rejected'
    ORDER BY Person.LastName;";
    ...
    FROM Person
      JOIN Application ON Person.PersonID = Application.PersonID
      JOIN Department ON Application.DepartmentID = Department.DepartmentID
      WHERE Department.DepartmentID = 3 AND Application.ApplicationStatus = 'Accepted' or Department.DepartmentID = 3 AND Application.ApplicationStatus = 'Rejected'
    ORDER BY Person.LastName;";
    ...
    FROM Person
      JOIN Application ON Person.PersonID = Application.PersonID
      JOIN Department ON Application.DepartmentID = Department.DepartmentID
      WHERE Department.DepartmentID = 4 AND Application.ApplicationStatus = 'Accepted' or Department.DepartmentID = 4 AND Application.ApplicationStatus = 'Rejected'
    ORDER BY Person.LastName;";
...
<head>
    ...
    <title>Wildlife Center of Virginia | Archived Applications</title>
...
<body>
<div id="wrapper">
<form name = "ArchivedApplications" method="post">
        ...
        <div class="col-md-12">
            <div class = "row">
                <header class="archivedapps-header-background" class="image-bg-fluid-height " >
                    ...
                    <h1 class="welcome-user"> ARCHIVED APPLICATIONS </h1>
                </header>
            </div>
        </div>
        <!--Start Table -->
        ...
        <div id = "all" class="pendingapps_table">
            <table class="table table-striped">
                ...
                <tr>
                    ...
                    <th class="pendingapps_header_content">Notes</th>
                </tr>
                </thead>
                <?php
