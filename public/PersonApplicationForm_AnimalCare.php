        ...
        <div class="row">
            ...
            <div class="col-sm-12">
                <form role="form" name="PersonApplicationForm_AnimalCare" method="post" action="PersonApplicationForm_AnimalCare.php">
                    ...
                    <div class="col-md-6 col-md-offset-3"><div class="form-group"><label>Please briefly describe your relevant hands-on experience with animals, if any. What did you enjoy about the experience? What did you dislike?</label> <textarea name="PreviousExperience" rows="4" class="form-control"></textarea></div></div>
                    ...
                    <div class="col-md-6 col-md-offset-3"><div class="form-group"><label>Is there anything else that you’d like us to know about yourself or your experience?<textarea name="OtherNotes" rows="4" class="form-control"></textarea></div></div>
