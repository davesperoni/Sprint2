...
<body>
          ...
          <div class="modal-body">
            ...
            <!-- QuickSave/Edit FORM -->
          	<form id="modal-form-body">
                ...
                <label>How many people can join this event?:</label>
                <select id="repeat_select" name="maxVolAmount" class="form-control">
                    <?php
                    for ($x = 0; $x <= 30; $x++) {
	...
	<div class="navbar navbar-default navbar-fixed-top">
		<div class="navbar-inner">
            <div class = "ughChangeColorPls">
			<div class="container">
				<a class="navbar-brand" href="index.php">Wildlife Center of Virginia</a>
