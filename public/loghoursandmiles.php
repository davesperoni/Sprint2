...
$sqlShowHours= "SELECT Person.FirstName AS 'FN', Person.MiddleInitial AS 'MI', Person.LastName AS 'LN', Shift.ShiftID AS 'ShiftID',
   Shift.DepartmentID AS 'Dept', Shift.ShiftDate AS 'ShiftDate', Shift.ShiftHours AS 'ShiftHours',
   Shift.StartTime AS 'StartTime', Shift.EndTime AS 'EndTime', Volunteer.YTDHours AS 'TotalHours',
   Volunteer.YTDMiles AS 'TotalMiles' FROM Person
...
/*$sqlHoursMiles= "SELECT Volunteer.YTDHours AS 'TotalHours', Volunteer.YTDMiles AS 'TotalMiles' FROM Person JOIN Volunteer ON Person.PersonID = Volunteer.PersonID";
*/

$currentAccountID = $_SESSION['AccountID'];

$sqlHoursMiles= "SELECT SUM(Volunteer.YTDHours) AS 'TotalHours', SUM(Volunteer.YTDMiles) AS 'TotalMiles' 
...
/*$sqlShowMiles = "Select Mileage.TripID AS 'TripID', Mileage.TripDate AS 'TripDate', Mileage.TripMiles AS 'TripMiles', Mileage.PickUpStreet AS 'Street', Mileage.PickUpCity AS 'City', Mileage.PickUpState AS 'State', Mileage.PickUpCountyName AS 'County', Mileage.PickUpZipCode AS 'Zip', Mileage.AnimalTransported AS 'Animal' from Mileage JOIN Volunteer ON Volunteer.VolunteerID = Mileage.VolunteerID";
*/
$sqlShowMiles = "Select Mileage.TripID AS 'TripID', Mileage.TripDate AS 'TripDate', Mileage.TripMiles AS 'TripMiles',
       ...
       Mileage.PickUpCountyName AS 'County', Mileage.PickUpZipCode AS 'Zip', Mileage.AnimalTransported AS 'Animal'
        FROM Mileage
        JOIN Volunteer ON Volunteer.VolunteerID = Mileage.VolunteerID
...
// Check connection
    ...
    $result = $conn->query("Select Mileage.TripID AS 'TripID', Mileage.TripDate AS 'TripDate', Mileage.TripMiles AS 'TripMiles',
       Mileage.PickUpStreet AS 'Street', Mileage.PickUpCity AS 'City', Mileage.PickUpState AS 'State',
       Mileage.PickUpCountyName AS 'County', Mileage.PickUpZipCode AS 'Zip', Mileage.AnimalTransported AS 'Animal'
FROM Mileage
JOIN VolunteerDepartment ON VolunteerDepartment.VolunteerID = Mileage.VolunteerID
...
WHERE Account.AccountID = '$currentAccountID';");
    ...
    if ($fp && $result) {
        ...
        header('Content-Disposition: attachment; filename="HabitatExportMiles.csv"');
...
// Check connection
    ...
    $result = $conn->query("SELECT Person.FirstName AS 'FN', Person.MiddleInitial AS 'MI', Person.LastName AS 'LN', Shift.ShiftID AS 'ShiftID',
       Shift.DepartmentID AS 'Dept', Shift.ShiftDate AS 'ShiftDate', Shift.ShiftHours AS 'ShiftHours',
       Shift.StartTime AS 'StartTime', Shift.EndTime AS 'EndTime' FROM Person
  JOIN Volunteer ON Person.PersonID = Volunteer.PersonID
  JOIN VolunteerDepartment ON Volunteer.VolunteerID = VolunteerDepartment.VolunteerID
  JOIN Shift ON VolunteerDepartment.VolunteerID = Shift.VolunteerID
  JOIN Account ON Person.AccountID = Account.AccountID
  WHERE Account.AccountID = '$currentAccountID';");
    ...
    if ($fp && $result) {
        header('Content-Type: text/csv');
        header('Content-Disposition: attachment; filename="HabitatExportHours.csv"');
        header('Pragma: no-cache');
        header('Expires: 0');
        fputcsv($fp, $headers);
        while ($row = $result->fetch_array(MYSQLI_NUM)) {
        ...
        <div class = "row btmSpace">
            ...
            <div class = "col-sm-6">
                <div class = "updateNumbers">
                    <h1 class = "updateTitle biggerTitle">  <?php echo $TotalHours ?></h1>
            ...
            <div class = "col-sm-6">
                <div class = "updateNumbers">
                    <h1 class = "updateTitle biggerTitle"> <?php echo $TotalMiles ?> </h1>
                ...
                <div class = "row">
                    <div class = "col-sm-6">
                        ...
                        <a href="#" class = "editBtns" id = "editMiles1" data-toggle = "modal" data-target = "#editMiles" disabled=> Add Miles <i class="fa fa-pencil"></i></a>
        ...
        <div class = "row btmSpaceLess">
            <div class = "col-sm-10 col-sm-offset-1">
                ...
                <div id = "wrapperPlaceLog1">
					...
					<form name="exportHours" action="loghoursandmiles.php" method="post">
                        <button class="btn btn-sm btn-primary pull-right" name="exportHours" type="submit" ><strong>Export Hours</strong></button>
                    </form>
                ...
                <form name="exportMiles" action="loghoursandmiles.php" method="post">
                        <button class="btn btn-sm btn-primary pull-right" name="exportMiles" type="submit" ><strong>Export Miles</strong></button>
                    </form>
