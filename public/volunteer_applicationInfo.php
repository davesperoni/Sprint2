...
<div id="wrapper">
    ...
    <div id="page-wrapper" class="gray-bg">
        ...
        <div class = "row">
            <div class = "col-sm-12">
                <header style="background-image:url('img/owlpeak.jpg');"class="image-bg-fluid-height " >
                ...
                <div class="pendingapps_table">
                    <table class="table table-striped">
                        ...
                        <tr>
                            ...
                            <td><button onclick = "location.href='#'" class="btn btn-sm btn-primary pull-right" name="ViewPersonApplication" type="submit" class="viewapp">View</button></td>
